...
public class PalletPackingStandardBox9Test {

    @Test
    void testPalletStandardBox9_matchesExpectedJson() throws Exception {
        URL inUrl = getClass().getResource("/pallet_packing/oversized_pallet/standard_box_9/input.csv");
        ...
        URL expectedUrl = getClass().getResource("/pallet_packing/oversized_pallet/standard_box_9/expected_output.json");
