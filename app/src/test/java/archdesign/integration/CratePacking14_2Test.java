...
public class CratePacking14_2Test {

    @Test
    void test14PerCrates2_matchesExpectedJson() throws Exception {
        URL inUrl = getClass().getResource("/crate_packing/DifferentSizeSameMedium/pack_long_direction/14_per_crates_2/input.csv");
        ...
        URL expectedUrl = getClass().getResource("/crate_packing/DifferentSizeSameMedium/pack_long_direction/14_per_crates_2/expected_output.json");
