...
public class CratePackingShort25Test {

    @Test
    void testShort25PerCrates1_matchesExpectedJson() throws Exception {
        URL inUrl = getClass().getResource("/crate_packing/DifferentSizeSameMedium/pack_short_direction/25_per_crates_1/input.csv");
        ...
        URL expectedUrl = getClass().getResource("/crate_packing/DifferentSizeSameMedium/pack_short_direction/25_per_crates_1/expected_output.json");
