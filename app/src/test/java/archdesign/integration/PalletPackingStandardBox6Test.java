...
public class PalletPackingStandardBox6Test {

    @Test
    void testStandardBox6_matchesExpectedJson() throws Exception {
        URL inUrl = getClass().getResource("/pallet_packing/standard_pallet/standard_box/standard_box_6/input.csv");
        ...
        URL expectedUrl = getClass().getResource("/pallet_packing/standard_pallet/standard_box/standard_box_6/expected_output.json");
