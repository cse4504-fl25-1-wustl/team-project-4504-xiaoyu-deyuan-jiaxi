...
public class CratePackingShort18_2Test {

    @Test
    void testShort18PerCrates2_matchesExpectedJson() throws Exception {
        URL inUrl = getClass().getResource("/crate_packing/DifferentSizeSameMedium/pack_short_direction/18_per_crates_2/input.csv");
        ...
        URL expectedUrl = getClass().getResource("/crate_packing/DifferentSizeSameMedium/pack_short_direction/18_per_crates_2/expected_output.json");
