...
public class PalletPackingStandardBox5Test {

    @Test
    void testPalletStandardBox5_matchesExpectedJson() throws Exception {
        URL inUrl = getClass().getResource("/pallet_packing/oversized_pallet/standard_box_5/input.csv");
        ...
        URL expectedUrl = getClass().getResource("/pallet_packing/oversized_pallet/standard_box_5/expected_output.json");
