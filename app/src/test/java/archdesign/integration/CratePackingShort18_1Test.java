...
public class CratePackingShort18_1Test {

    @Test
    void testShort18PerCrates1_matchesExpectedJson() throws Exception {
        URL inUrl = getClass().getResource("/crate_packing/SameSizeSameMedium/pack_short_direction/18_per_crates_1/input.csv");
        ...
        URL expectedUrl = getClass().getResource("/crate_packing/SameSizeSameMedium/pack_short_direction/18_per_crates_1/expected_output.json");
