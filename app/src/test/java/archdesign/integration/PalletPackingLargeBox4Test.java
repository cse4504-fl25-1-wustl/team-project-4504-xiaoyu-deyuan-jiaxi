...
public class PalletPackingLargeBox4Test {

    @Test
    void testLargeBox4_matchesExpectedJson() throws Exception {
        URL inUrl = getClass().getResource("/pallet_packing/standard_pallet/large_box/large_box_4/input.csv");
        ...
        URL expectedUrl = getClass().getResource("/pallet_packing/standard_pallet/large_box/large_box_4/expected_output.json");
