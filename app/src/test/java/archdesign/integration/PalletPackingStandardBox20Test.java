...
public class PalletPackingStandardBox20Test {

    @Test
    void testStandardBox20_matchesExpectedJson() throws Exception {
        URL inUrl = getClass().getResource("/pallet_packing/oversized_pallet/standard_box_20/input.csv");
        ...
        URL expectedUrl = getClass().getResource("/pallet_packing/oversized_pallet/standard_box_20/expected_output.json");
