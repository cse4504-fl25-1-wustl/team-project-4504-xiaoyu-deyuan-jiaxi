...
public class CratePackingShort25_2_SameTest {

    @Test
    void testShort25PerCrates2_Same_matchesExpectedJson() throws Exception {
        URL inUrl = getClass().getResource("/crate_packing/SameSizeSameMedium/pack_short_direction/25_per_crates_2/input.csv");
        ...
        URL expectedUrl = getClass().getResource("/crate_packing/SameSizeSameMedium/pack_short_direction/25_per_crates_2/expected_output.json");
        ...
        if (obj.has("oversized_pallet_count")) {
            ...
            if ("true".equalsIgnoreCase(System.getProperty("packing.preferCrates"))) {
                // allow a single oversized pallet when crate-preference falls back
