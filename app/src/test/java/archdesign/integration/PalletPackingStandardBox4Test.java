...
public class PalletPackingStandardBox4Test {

    @Test
    void testStandardBox4_matchesExpectedJson() throws Exception {
        URL inUrl = getClass().getResource("/pallet_packing/standard_pallet/standard_box/standard_box_4/input.csv");
        ...
        URL expectedUrl = getClass().getResource("/pallet_packing/standard_pallet/standard_box/standard_box_4/expected_output.json");
