...
public class PalletPackingMixedStandard1Large5Test {

    @Test
    void testMixedStandard1Large5_matchesExpectedJson() throws Exception {
        URL inUrl = getClass().getResource("/pallet_packing/standard_pallet/mixed_boxes/standard_box_1_large_box_5/input.csv");
        ...
        URL expectedUrl = getClass().getResource("/pallet_packing/standard_pallet/mixed_boxes/standard_box_1_large_box_5/expected_output.json");
