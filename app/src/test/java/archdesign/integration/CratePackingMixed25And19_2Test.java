...
public class CratePackingMixed25And19_2Test {

    @Test
    void testMixed25And19PerCrates2_matchesExpectedJson() throws Exception {
        URL inUrl = getClass().getResource("/crate_packing/DifferentSizeSameMedium/pack_mixed_directions/25_and_19_per_crates_2/input.csv");
        ...
        URL expectedUrl = getClass().getResource("/crate_packing/DifferentSizeSameMedium/pack_mixed_directions/25_and_19_per_crates_2/expected_output.json");
