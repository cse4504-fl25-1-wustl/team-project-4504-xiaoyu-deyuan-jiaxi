...
public class PalletPackingMixedStandard6Large1Test {

    @Test
    void testMixedStandard6Large1_matchesExpectedJson() throws Exception {
        URL inUrl = getClass().getResource("/pallet_packing/standard_pallet/mixed_boxes/standard_box_6_large_box_1/input.csv");
        ...
        URL expectedUrl = getClass().getResource("/pallet_packing/standard_pallet/mixed_boxes/standard_box_6_large_box_1/expected_output.json");
