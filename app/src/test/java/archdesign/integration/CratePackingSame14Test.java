...
public class CratePackingSame14Test {

    @Test
    void testSame14PerCrates1_matchesExpectedJson() throws Exception {
        URL inUrl = getClass().getResource("/crate_packing/SameSizeSameMedium/pack_long_direction/14_per_crates_1/input.csv");
        ...
        URL expectedUrl = getClass().getResource("/crate_packing/SameSizeSameMedium/pack_long_direction/14_per_crates_1/expected_output.json");
