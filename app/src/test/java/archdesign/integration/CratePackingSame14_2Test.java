...
public class CratePackingSame14_2Test {

    @Test
    void testSame14PerCrates2_matchesExpectedJson() throws Exception {
        URL inUrl = getClass().getResource("/crate_packing/SameSizeSameMedium/pack_long_direction/14_per_crates_2/input.csv");
        ...
        URL expectedUrl = getClass().getResource("/crate_packing/SameSizeSameMedium/pack_long_direction/14_per_crates_2/expected_output.json");
