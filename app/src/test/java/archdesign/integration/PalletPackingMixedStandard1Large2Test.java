...
public class PalletPackingMixedStandard1Large2Test {

    @Test
    void testMixedStandard1Large2_matchesExpectedJson() throws Exception {
        URL inUrl = getClass().getResource("/pallet_packing/standard_pallet/mixed_boxes/standard_box_1_large_box_2/input.csv");
        ...
        URL expectedUrl = getClass().getResource("/pallet_packing/standard_pallet/mixed_boxes/standard_box_1_large_box_2/expected_output.json");
