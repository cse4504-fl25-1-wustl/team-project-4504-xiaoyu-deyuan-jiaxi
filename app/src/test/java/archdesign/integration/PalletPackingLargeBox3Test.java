...
public class PalletPackingLargeBox3Test {

    @Test
    void testLargeBox3_matchesExpectedJson() throws Exception {
        URL inUrl = getClass().getResource("/pallet_packing/standard_pallet/large_box/large_box_3/input.csv");
        ...
        URL expectedUrl = getClass().getResource("/pallet_packing/standard_pallet/large_box/large_box_3/expected_output.json");
