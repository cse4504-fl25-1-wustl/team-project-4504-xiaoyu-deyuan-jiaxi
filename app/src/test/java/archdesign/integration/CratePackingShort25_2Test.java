...
public class CratePackingShort25_2Test {

    @Test
    void testShort25PerCrates2_matchesExpectedJson() throws Exception {
        URL inUrl = getClass().getResource("/crate_packing/DifferentSizeSameMedium/pack_short_direction/25_per_crates_2/input.csv");
        ...
        URL expectedUrl = getClass().getResource("/crate_packing/DifferentSizeSameMedium/pack_short_direction/25_per_crates_2/expected_output.json");
