...
public class ArtTest {
    ...
    public void weightCalculationUsesMaterialFactor() {
        ...
        double expected = Math.ceil(10 * 20 * Material.GLASS.getWeight());
    ...
    public void glassMaterial_CalculatesCorrectWeight() {
        ...
        double expected = Math.ceil(8 * 12 * Material.GLASS.getWeight());
    ...
    public void acrylicMaterial_CalculatesCorrectWeight() {
        ...
        double expected = Math.ceil(6 * 8 * Material.ACRYLIC.getWeight());
        assertEquals(expected, art.getWeight(), 1e-9);
    }
    ...
    public void canvasFramedMaterial_CalculatesCorrectWeight() {
        ...
        double expected = Math.ceil(20 * 30 * Material.CANVAS_FRAMED.getWeight());
        assertEquals(expected, art.getWeight(), 1e-9);
    }
    ...
    public void negativeDimensions_CalculateWeightCorrectly() {
        ...
        double expected = Math.ceil((-5) * 10 * Material.GLASS.getWeight());
        assertEquals(expected, art.getWeight(), 1e-9);
    }
    ...
    public void zeroThickness_IsAllowed() {
        ...
        assertNotNull(art);
        assertEquals(Math.ceil(10 * 10 * Material.GLASS.getWeight()), art.getWeight(), 1e-12);
    }
    ...
    public void largeDimensions_HandleCorrectly() {
        ...
        double expected = Math.ceil(10000 * 10000 * Material.CANVAS_FRAMED.getWeight());
        assertEquals(expected, art.getWeight(), 1e-9);
    }
    ...
    public void artObjectsWithDifferentDimensions_HaveDifferentWeights() {
        ...
        double expectedSmall = Math.ceil(smallArt.getHeight() * smallArt.getWidth() * smallArt.getMaterial().getWeight());
        double expectedLarge = Math.ceil(largeArt.getHeight() * largeArt.getWidth() * largeArt.getMaterial().getWeight());

        // Verify each matches production formula
        assertEquals(expectedSmall, smallArt.getWeight(), 1e-9);
        assertEquals(expectedLarge, largeArt.getWeight(), 1e-9);

        if (expectedSmall != expectedLarge) {
    ...
    public void artObjectsWithDifferentMaterials_HaveDifferentWeights() {
        ...
        double expectedGlass = Math.ceil(glassArt.getHeight() * glassArt.getWidth() * glassArt.getMaterial().getWeight());
        double expectedCanvas = Math.ceil(canvasArt.getHeight() * canvasArt.getWidth() * canvasArt.getMaterial().getWeight());

        // Verify each matches production formula
        assertEquals(expectedGlass, glassArt.getWeight(), 1e-9);
        assertEquals(expectedCanvas, canvasArt.getWeight(), 1e-9);

        // If expected weights differ, assert they are different; otherwise accept equality (due to rounding behavior)
        if (expectedGlass != expectedCanvas) {
    ...
    public void squareArt_CalculatesCorrectWeight() {
        ...
        double expected = Math.ceil(10 * 10 * Material.GLASS.getWeight());
        assertEquals(expected, art.getWeight(), 1e-9);
    }
    ...
    public void rectangularArt_CalculatesCorrectWeight() {
        ...
        double expected = Math.ceil(5 * 20 * Material.ACRYLIC.getWeight());
        assertEquals(expected, art.getWeight(), 1e-9);
    }
    ...
    public void differentMaterialsWithSameDimensions_HaveDifferentWeights() {
        ...
        // Verify each art's weight matches the production formula (ceil of area * material weight)
        for (Art art : arts) {
            double expected = Math.ceil(art.getHeight() * art.getWidth() * art.getMaterial().getWeight());
            assertEquals(expected, art.getWeight(), 1e-9, "Weight mismatch for material " + art.getMaterial());
        }
    }
    ...
    public void weightCalculationIsDeterministic() {
        ...
        double expectedWeight = Math.ceil(7 * 13 * Material.GLASS.getWeight());
