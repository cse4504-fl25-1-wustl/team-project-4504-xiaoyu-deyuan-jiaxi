...
/**
 * Test for VaryingSizes/36.5x36.5
 * ✅ Expected: still STANDARD box (since 36.5 → ceil → 37 ≤ 43 rule applies)
 */
public class Size36_5x36_5Test {

    private static final String BASE_DIR = "/box_packing/VaryingSizes/36.5x36.5";

    @Test
    public void test_36_5x36_5_StandardBox() throws Exception {
        System.out.println(">>> Running test for folder: 36.5x36.5");

        URL inputUrl = getClass().getResource(BASE_DIR + "/input.csv");
        URL expectedUrl = getClass().getResource(BASE_DIR + "/expected_output.json");
        assertNotNull(inputUrl, "input.csv missing in 36.5x36.5");
        assertNotNull(expectedUrl, "expected_output.json missing in 36.5x36.5");
        ...
        System.out.println("--- Shipment Debug (36.5x36.5) ---");
        ...
        // ✅ Assertions (compare to expected_output.json)
