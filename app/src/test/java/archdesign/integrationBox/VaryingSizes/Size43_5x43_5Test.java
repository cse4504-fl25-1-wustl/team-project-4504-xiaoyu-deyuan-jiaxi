...
/**
 * Test for VaryingSizes/43.5x43.5
 * ✅ Expected: Large Box (since 43.5 → ceil → 44, exceeds standard max size 43)
 */
public class Size43_5x43_5Test {

    private static final String BASE_DIR = "/box_packing/VaryingSizes/43.5x43.5";

    @Test
    public void test_43_5x43_5_LargeBox() throws Exception {
        System.out.println(">>> Running test for folder: 43.5x43.5");

        URL inputUrl = getClass().getResource(BASE_DIR + "/input.csv");
        URL expectedUrl = getClass().getResource(BASE_DIR + "/expected_output.json");
        assertNotNull(inputUrl, "input.csv missing in 43.5x43.5");
        assertNotNull(expectedUrl, "expected_output.json missing in 43.5x43.5");
        ...
        System.out.println("--- Shipment Debug (43.5x43.5) ---");
