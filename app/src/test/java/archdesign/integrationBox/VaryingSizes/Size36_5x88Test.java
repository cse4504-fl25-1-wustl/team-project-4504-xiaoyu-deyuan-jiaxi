...
/**
 * Test for VaryingSizes/36.5x88
 * ✅ Expected: Should fit into STANDARD box (since 36.5x88 after ceil → 37x88)
 */
public class Size36_5x88Test {

    private static final String BASE_DIR = "/box_packing/VaryingSizes/36.5x88";

    @Test
    public void test_36_5x88_StandardBox() throws Exception {
        System.out.println(">>> Running test for folder: 36.5x88");

        URL inputUrl = getClass().getResource(BASE_DIR + "/input.csv");
        URL expectedUrl = getClass().getResource(BASE_DIR + "/expected_output.json");
        assertNotNull(inputUrl, "input.csv missing in 36.5x88");
        assertNotNull(expectedUrl, "expected_output.json missing in 36.5x88");
        ...
        System.out.println("--- Shipment Debug (36.5x88) ---");
        ...
        // ✅ Assertions (compare with expected_output.json)
