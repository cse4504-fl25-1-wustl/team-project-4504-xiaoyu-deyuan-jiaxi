...
public class Size43x88_5Test {
    ...
    public void test_43x88_5_LargeBox() throws Exception {
        ...
        assertNotNull(inputUrl, "input.csv missing in 43x88.5");
        assertNotNull(expectedUrl, "expected_output.json missing in 43x88.5");
        ...
        System.out.println("--- Shipment Debug (43x88.5) ---");
