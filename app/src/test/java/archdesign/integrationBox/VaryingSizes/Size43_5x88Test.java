...
/**
 * Test for VaryingSizes/43.5x88
 * ✅ Expected: LARGE box (width 43.5 → ceil 44 > 43)
 */
public class Size43_5x88Test {

    private static final String BASE_DIR = "/box_packing/VaryingSizes/43.5x88";

    @Test
    public void test_43_5x88_LargeBox() throws Exception {
        System.out.println(">>> Running test for folder: 43.5x88");

        // 1️⃣ Load resources
        URL inputUrl = getClass().getResource(BASE_DIR + "/input.csv");
        URL expectedUrl = getClass().getResource(BASE_DIR + "/expected_output.json");
        assertNotNull(inputUrl, "input.csv missing in 43.5x88");
        assertNotNull(expectedUrl, "expected_output.json missing in 43.5x88");
        ...
        // 5️⃣ Debug print
        System.out.println("--- Shipment Debug (43.5x88) ---");
