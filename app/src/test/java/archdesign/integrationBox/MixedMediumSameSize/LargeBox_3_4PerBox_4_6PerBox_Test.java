...
public class LargeBox_3_4PerBox_4_6PerBox_Test {

    @Test
    public void testSingleCase() throws Exception {
        URL resource = getClass().getClassLoader().getResource(
                "box_packing/MixedMediumSameSize/LargeBox/3_4PerBox-4_6PerBox/input.csv");
        ...
        URL expectedUrl = getClass().getClassLoader().getResource(
                "box_packing/MixedMediumSameSize/LargeBox/3_4PerBox-4_6PerBox/expected_output.json");
