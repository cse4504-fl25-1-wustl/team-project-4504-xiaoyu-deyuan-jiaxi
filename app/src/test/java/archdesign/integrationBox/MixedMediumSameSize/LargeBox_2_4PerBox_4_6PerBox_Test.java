...
public class LargeBox_2_4PerBox_4_6PerBox_Test {

    @Test
    public void testSingleCase() throws Exception {
        URL resource = getClass().getClassLoader().getResource(
                "box_packing/MixedMediumSameSize/LargeBox/2_4PerBox-4_6PerBox/input.csv");
        ...
        URL expectedUrl = getClass().getClassLoader().getResource(
                "box_packing/MixedMediumSameSize/LargeBox/2_4PerBox-4_6PerBox/expected_output.json");
