...
public class LargeBox_4_4PerBox_1_6PerBox_Test {

    @Test
    public void testSingleCase() throws Exception {
        URL resource = getClass().getClassLoader().getResource(
                "box_packing/MixedMediumSameSize/LargeBox/4_4PerBox-1_6PerBox/input.csv");
        ...
        URL expectedUrl = getClass().getClassLoader().getResource(
                "box_packing/MixedMediumSameSize/LargeBox/4_4PerBox-1_6PerBox/expected_output.json");
